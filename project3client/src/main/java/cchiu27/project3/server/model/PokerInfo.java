...
public class PokerInfo implements Serializable {
    ...
    // Cards
    private ArrayList<cchiu27.project3.server.model.Card> playerHand;
    private ArrayList<cchiu27.project3.server.model.Card> dealerHand;
    ...
    public ArrayList<cchiu27.project3.server.model.Card> getPlayerHand() {
        return playerHand;
    }

    public void setPlayerHand(ArrayList<cchiu27.project3.server.model.Card> playerHand) {
        this.playerHand = playerHand;
    }

    public ArrayList<cchiu27.project3.server.model.Card> getDealerHand() {
        return dealerHand;
    }

    public void setDealerHand(ArrayList<cchiu27.project3.server.model.Card> dealerHand) {
